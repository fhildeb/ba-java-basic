...
public class TicTacToe {
	...
	// Ueberpruefung aller Moeglichkeiten fuer GameOver
	public boolean istGameOver() {
		// Reihe 1
		if (feld[0] != LEER && feld[0] == feld[1] && feld[1] == feld[2])
			return true;

		// Reihe 2
		if (feld[3] != LEER && feld[3] == feld[4] && feld[4] == feld[5])
			return true;

		// Reihe 3
		if (feld[6] != LEER && feld[6] == feld[7] && feld[7] == feld[8])
			return true;

		// Spalte 1
		if (feld[0] != LEER && feld[0] == feld[3] && feld[3] == feld[6])
			return true;

		// Spalte 1
		if (feld[1] != LEER && feld[1] == feld[4] && feld[4] == feld[7])
			return true;

		// Spalte 1
		if (feld[2] != LEER && feld[2] == feld[5] && feld[5] == feld[8])
			return true;

		// Diagonale 1
		if (feld[0] != LEER && feld[0] == feld[4] && feld[4] == feld[8])
			return true;

		// Diagonale 2
		if (feld[2] != LEER && feld[2] == feld[4] && feld[4] == feld[6])
			return true;
	...
	public void zugComputer() {
		...
		System.out.println("Computer waehlte Feld " + wahlFeld);
		ausgeben();
	}
}